            ...
            modelBuilder.Entity("ProductFeederCoreLib.Models.Condition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDateTimeStamp = new DateTime(2022, 8, 25, 19, 10, 35, 62, DateTimeKind.Local).AddTicks(2658),
                        ...
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDateTimeStamp = new DateTime(2022, 8, 25, 19, 10, 35, 62, DateTimeKind.Local).AddTicks(2706),
            ...
            modelBuilder.Entity("ProductFeederCoreLib.Models.Shipping", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDateTimeStamp = new DateTime(2022, 8, 25, 19, 10, 35, 62, DateTimeKind.Local).AddTicks(2968),
                        ...
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDateTimeStamp = new DateTime(2022, 8, 25, 19, 10, 35, 62, DateTimeKind.Local).AddTicks(2977),
            ...
            modelBuilder.Entity("ProductFeederCoreLib.Models.Product", b =>
                {
                    ...
                    b.HasOne("ProductFeederCoreLib.Models.Shipping", "Shipping")
                        .WithMany()
